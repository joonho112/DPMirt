...
Displays item difficulty (beta) estimates with posterior credible
intervals. For 2PL/3PL models, also shows discrimination (lambda)
estimates. Requires ggplot2.
